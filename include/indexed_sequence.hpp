...
namespace pvb {
    ...
    struct indexed_sequence {
        ...
        bitsize(global_parameters const& params, uint64_t third_cost, uint64_t universe, uint64_t n)
        {
                       ...
                       global_parameters& params)
            {
                ...
                switch (m_type) {
                    case third:
                        ...
                        m_th_enumerator = typename Encoder::enumerator(bv, offset + type_bits + pad,
                                                                       universe, n, params);
                        break;
                    case ranked_bitvector:
                        // if (n > 2048)
