...
public:
    ...
    class builder {
    public:
        builder(global_parameters const& params) : m_params(params) {
        ...
        void build(bitvector_collection& sq) {
            ...
            compact_elias_fano::write(bvb, m_endpoints.begin(),
                                      m_bitvectors.size(), sq.m_size, m_params);
    ...
    succinct::bit_vector::enumerator get(global_parameters const& params,
                                         size_t i) const {
        assert(i < size());
        compact_elias_fano::enumerator endpoints(
            m_endpoints, 0, m_bitvectors.size(), m_size, params);
    ...
    void map(Visitor& visit) {
        visit(m_size, "m_size")(m_endpoints, "m_endpoints")(m_bitvectors,
                                                            "m_bitvectors");
    }
